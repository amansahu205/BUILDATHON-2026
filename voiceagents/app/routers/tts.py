...
async def narrate_coaching_brief(body: CoachingBriefRequest):
    ...
    if body.report_id and not narration_text:
        report_path = settings.reports_dir / f"{body.report_id}.json"
    ...
    voice_id = (
        settings.interrogator_voice_id if body.voice == "interrogator"
        else settings.coach_voice_id
    )
...
async def text_to_speech(body: TTSRequest):
    ...
    voice_id = body.voice_id or settings.coach_voice_id
